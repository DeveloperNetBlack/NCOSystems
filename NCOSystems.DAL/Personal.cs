...
namespace NCOSystems.DAL
{
    public class Personal
    {
        public void Insertar(PersonalEntity personalEntity, IConfiguration configuration)
        {
            ...
            parameters.addParameters("@PI_FEC_LICENCIA_B", TypeData.DataType.Date, 0, ParameterDirection.Input, personalEntity.FecLicenciaB);
        ...
        public void InsertarHijo(PersonalHijoEntity personalHijoEntity, IConfiguration configuration)
        {
            ...
            parameters.addParameters("@PI_NOMBRE_HIJO", TypeData.DataType.Varchar, 80, ParameterDirection.Input, personalHijoEntity.NombreHijo!);
